      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          <h1 className="text-3xl font-bold leading-10 text-white md:font-extrabold lg:text-[2.6rem] lg:leading-[3.5rem] ">
            Hello, <br /> 
            This is {' '}
            <span className=" text-blue-500">{personalData.name}</span><br />
            {`  I'm a   `}
        ...
        <div className="order-1 lg:order-2 from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#1a0d37]">
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-green-300">Raihan Fathurrahman</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              ...
              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-white">workethic:</span>
              ...
              <div>
                ...
                <span className="mr-2 text-white">workethic</span>
              ...
              <div><span className="text-gray-400 typewriter">{`};`}</span></div>
            </code>
          </div>
        </div>
      </div>
